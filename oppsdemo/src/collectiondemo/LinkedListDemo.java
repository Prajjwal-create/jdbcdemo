...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
        ...
        System.out.println("********* retrive element from linked *******");
        System.out.println("last friend in a list:"+friends.getFirst());
        System.out.println("last friend in a list:"+friends.getLast());
        System.out.println("Delete a last friend :"+friends.remove("Wait"));
        System.out.println("Find position of john in:" +friends.indexOf("John"));
